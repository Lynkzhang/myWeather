...
<html>
<head>
    <title><?php echo $_GET["city"];  ?>Details</title>
...
<a><input type="button" value="Back" onclick="location='admin.php'" /></a>
...
$sql = sprintf("select %s from cityname_id where cityname_en <> 'NULL'", implode(",",$dbcolarray));
